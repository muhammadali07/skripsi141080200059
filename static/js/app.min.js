! function(n, a, o) {
  ...
  if (o(n).on("load", function() {
      ...
      }), 0 < o(".scrollable-container").length && o(".scrollable-container").each(function() {
  ...
  o(a).on("click", ".menu-toggle, .modern-nav-toggle", function(e) {
    return e.preventDefault(), o(".user-profile .user-info .dropdown").hasClass("show") && (o(".user-profile .user-info .dropdown").removeClass("show"), o(".user-profile .user-info .dropdown .dropdown-menu").removeClass("show")), o.app.menu.toggle(), setTimeout(function() {
      o(n).trigger("resize")
